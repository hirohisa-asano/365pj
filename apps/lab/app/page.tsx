...
const apps: { name: string; description: string; features: string[]; url: string; isNew?: boolean }[] = [
	// アプリ公開後にここに追加
	// {
	// 	name: "LLMコスト計算",
	// 	description: "GPT・Claude・Geminiの月額コストをパターン別に比較できる",
	// 	features: ["モデル別の料金比較", "利用パターンから月額を試算", "コスト最適なモデルを提案"],
	// 	url: "https://llm-cost.southernlabs.com",
	// 	isNew: true,
	// },
];
				...
				<section className="px-4 py-24">
					<div className="mx-auto max-w-3xl grid gap-6 md:grid-cols-2">
						...
						{discordUrl && (
							...
							>
								<svg width="40" height="40" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
								...
								<div>
									<p className="text-white font-semibold text-base">Discord に参加する</p>
									<p className="text-white/70 text-xs mt-1">バグ報告・要望・雑談はこちらで</p>
								</div>
							</a>
						)}
						...
						{/* Member */}
						<div
							className="flex flex-col gap-4 p-6 md:p-8 rounded-[var(--radius)] border-2 border-border bg-muted/30 opacity-60 cursor-not-allowed"
						>
							<div>
