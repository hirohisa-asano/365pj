...
`/improve` コマンドの手順に従い、実際の画面を見て改善提案を行う。

1. dev サーバーを起動し、スクショ撮影・API テスト
2. 初見のわかりやすさ / 入力体験 / 結果の満足度 / リピート動機 / 小機能 の観点で3〜5個提案
3. 人間が採用する提案を選択 → 実装 → 再確認
4. **最大3ターン繰り返し。人間がOKと言ったら次へ**
5. `IMPROVE.md` 出力
